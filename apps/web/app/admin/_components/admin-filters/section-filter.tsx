...
export function SectionFilter({ section, filters, onFilterChange, onClearFilter, variants }: SectionFilterProps) {
  return (
    <Disclosure as={motion.div} variants={variants} className="border-t border-gray-200 px-4 py-4">
      {({ open }) => (
        <>
